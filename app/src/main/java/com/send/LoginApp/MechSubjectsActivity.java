...
public class MechSubjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (message != null) {
                Toast.makeText(MechSubjectsActivity.this, "ForgotPassword", Toast.LENGTH_SHORT).show();
            }
        }
        buy.setOnClickListener(v -> {
                Intent intent1 = new Intent(MechSubjectsActivity.this, BuyCourseActivity.class);
